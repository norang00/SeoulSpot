...
//  SeoulSpot
//
//  Created by Kyuhee hong on 4/11/25.
//

import UIKit
import SnapKit
final class BasicInfoCollectionViewCell: UICollectionViewCell {
    
    static let identifier = String(describing: BasicInfoCollectionViewCell.self)
    ...
    private func setupLayout() {
        ...
        thumbnailImageView.snp.makeConstraints {
            ...
            $0.width.equalTo(thumbnailImageView.snp.height).multipliedBy(0.7)
        }
